...
вхідного $U_1(t)$ та вихідного $U_2(t)$ імпульсів за шаблоном, наведеним на рис. 1.5%\ref{4}. За допомогою осцилографа визначити динамічні параметри ключа:
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|c|}
		...
		\begin{tabular}[c]{@{}c@{}}$R_6$\\ (П1-П4)\end{tabular} &  &  &  &  \\ \hline
		\begin{tabular}[c]{@{}c@{}}$VD_1$\\ (П1)\end{tabular}   &  &  &  &  \\ \hline
		(П2)                                                    &  &  &  &  \\ \hline
		\begin{tabular}[c]{@{}c@{}}$R_7$\\ (П4)\end{tabular}    &  &  &  &  \\ \hline
		\begin{tabular}[c]{@{}c@{}}$C_3$\\ (П3)\end{tabular}      &  &  &  &  \\ \hline
	\end{tabular}
...
----------------------------------------------------------
\fcolorbox{red}{red}{рисунок}рисунок 
\begin{center}
\fbox{ПЕРЕМИКАЧ НАПРУГИ НА МДН – ТРАНЗИСТОРІ С ІНДУКОВАНИМ КАНАЛОМ}
\end{center}

\textbf{Мета роботи} - дослідити статичні і динамічні параметри перемикача напруги на МДН - транзисторі з індукованим каналом.

\begin{figure}[h]
	\center{\includegraphics[width=0.6\linewidth]{5.png}}
...
\begin{figure}[h!]
	\center{\includegraphics[width=1\linewidth]{fortab2.png}}
