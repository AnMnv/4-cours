...
\begin{titlepage}
	...
	Перевірила: \hspace{5.9cm} $\underset{\text{(підпис)}}{\underline{\hspace{0.2\textwidth}}}$  \hspace{1cm}С.\,В.~Малюта\\
...
\begin{figure}[h!]
	\center{\includegraphics[width=0.4\linewidth]{picture1.pdf}}
	\caption{Принципова схема для логічної функції «АБО» на тунельному діоді.}
	\label{ris1}
\end{figure}

\begin{figure}[h!]
	\center{\includegraphics[width=0.6\linewidth]{22.png}}
...
\begin{figure}[h!]
	\center{\includegraphics[width=0.8\linewidth]{22.jpg}}
	%\caption{Принципова схема для логічної функції «АБО» на тунельному діоді.}
	%\label{ris1}
\end{figure}
