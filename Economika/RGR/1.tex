...
\hline%A                  B                   С       
 @$\rho$        & @ I ітер ($\beta$)  &       & @$\sum$\\ \hline
    1.14        & 0.15              &  a2*b2   &  \\ \hline
    0.98        & 0.13                &  a3*b3  &  \\ \hline
     0.79       & 0.1                 &  a4*b4   &  \\ \hline
     1.36       & 0.24                 &  a5*b5 &    \\ \hline
    1.33        & 0.21                &  a6*b6  &  \\ \hline
    1.25        & 0.18                &  a7*b7  &   \\ \hline
            &                       &  &  sum(c2:c7)    \\ \hline
    \end{spreadtab}
 \end{center}
