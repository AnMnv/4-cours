...
plt.plot([-0.0018, -lp1], [Ep2[0], Ep2[0]], 'm')
plt.plot([ln1, 0.0004], [Ep1[0], Ep1[0]], 'm')
...
plt.legend()
plt.savefig('/Users/antonmnacakanov/Desktop/$/zaiats/#3-300/1.pdf', dpi=1000)
...
plt.plot([x4[-1], 0.0004], [fin[-1], fin[-1]], 'm')
plt.plot([x22[-1], 0.0004], [fin2[-1], fin2[-1]], 'g')
plt.plot([-0.0018, -lp1], [fip1[0], fip1[0]], 'r')
plt.plot([x21[-1], 0.0004], [fin1[-1], fin1[-1]], 'r')
...
plt.legend()
plt.savefig('/Users/antonmnacakanov/Desktop/$/zaiats/#3-300/2.pdf', dpi=1000)
plt.close(fig)
#plt.show()
print("------------------------------")
print("* В рівноважному стані")
...
plt.plot(x3, -fip+(1.42/2), 'b', label="$E_C$ — енергія дна зони провідності")
...
print("EF<-->EV = ",  abs(-fip[0]-(1.42/2)) - abs(yEf[0]))
print(-fip[0]-(1.42/2))

print("EF<-->EC = ", abs(-fip[0]+(1.42/2)) + abs(yEf[0]))
print(-fip[0]+(1.42/2))


plt.plot(x3, -fip-(1.42/2), 'k', label="$E_V$ — енергія верху валентної зони")
...
plt.legend()
plt.savefig('/Users/antonmnacakanov/Desktop/$/zaiats/#3-300/3.pdf', dpi=1000)
...
plt.legend()
plt.savefig('/Users/antonmnacakanov/Desktop/$/zaiats/#3-300/3.1.pdf', dpi=1000)
plt.show()
