...
fig.savefig('/Users/antonmnacakanov/Desktop/III/ToF/rgr1/11.pdf', dpi=1000)
plt.close(fig)
...
ax.set_xlim([-0.1,6.1])
ax.set_ylim([-0.1,3.1])
fig.savefig('/Users/antonmnacakanov/Desktop/III/ToF/rgr1/21.pdf', dpi=1000)
plt.close(fig)
...
ax.set_xlim([-0.1,6.1])
ax.set_ylim([-0.1,3.1])
fig.savefig('/Users/antonmnacakanov/Desktop/III/ToF/rgr1/31.pdf', dpi=1000)
plt.close(fig)

f = open("/Users/antonmnacakanov/Desktop/III/ToF/rgr1/data.csv", "w")
for j in np.arange(xset+1):
    f.write(str(j)+";")
f.write('\n')
for i in np.arange(yset+1):
...
ax.set_xlim([-0.1,6.1])
ax.set_ylim([-0.1,3.1])
fig.savefig('/Users/antonmnacakanov/Desktop/III/ToF/rgr1/3.11.pdf', dpi=1000)
plt.close(fig)
