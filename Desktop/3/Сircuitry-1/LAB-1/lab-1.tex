...
\begin{landscape}
\begin{figure}[h]
\center{\includegraphics[angle=-90, width=1\linewidth]{1.1.pdf}}
\label{ris5}
...
\center{\includegraphics[width=1\linewidth]{t1.pdf}}
\label{ris2}
\end{figure}
...
\begin{figure}[h]
\center{\includegraphics[angle=-90,width=1\linewidth]{123.jpg}}
\end{figure}
