...
\begin{enumerate}
	...
	збільшенні енергії, знову знижується. Це пояснюється тим, 	що при 	збільшенні енергії зростає швидкість електрона, тобто час взаємодії 	скорочується, отже, менше і ймовірність взаємодії. \\ У разі частих	зіткнень можливе послідовне протікання непружних процесів, 	таких як багаторазова \\ 
	іонізація, ступінчаста  іонізація (іонізація збудженого атома).}
	...
	\item Поясніть залежність перерізів іонізації і перерізів пружного розсіяння від енергій.\\ \includegraphics[width=0.3\linewidth]{1.png}\\
