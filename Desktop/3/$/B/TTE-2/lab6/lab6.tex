...
\FPeval\s{round( (((230-200)*10^{-6})/0.5):8 )}
...
\FPeval\ri{round((0.25/(30*10^{-6})):2) }
\begin{align*}
...
\newpage
\begin{figure}[h]
\center{\includegraphics[width=0.7\linewidth]{228.pdf}}
