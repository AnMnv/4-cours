...
\FPeval\s{round( (((240-200)*10^{-6})/0.5):8 )}
...
\FPeval\tn{round(a/(3.7-3.2):0)}
\begin{align*}
  K_{Tn} = \dfrac{8-6}{3,7-3,2} = \FPprint{tn}
\end{align*}

К для Tу
\FPeval\ty{round(a/(6.4-5.4):0)}
\begin{align*}
  K_{Ty} = \dfrac{8-6}{6,3-5,4} = \FPprint{ty}
\end{align*}

К для Rн
\FPeval\rn{round(a/(7.5-6.9):0)}
\begin{align*}
...
\newpage
\begin{figure}[h]
\center{\includegraphics[width=0.8\linewidth]{1.pdf}}
