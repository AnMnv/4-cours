...
\begin{document}\Huge
\begin{enumerate}
  \item This is a \tooltip{tooltip}{\includegraphics[scale=0.1]{1.jpg}} with a graphic popping up on mouse-over in Acrobat Reader. The tooltip can be dragged around with the mouse.
